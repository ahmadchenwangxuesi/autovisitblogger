...
$merah = "\e[91m";
echo "$cyan ###################################################\n";
echo "$biru /     Auto Visitor Blogger / website v.1           /\n";
echo "$merah / CreatedBy : PACE USA                            /\n";
echo "$magenta / YOUTUBE   : http://www.youtube.com/           /\n";
echo "$hijau / Contact Me: +6281*********7                     /\n";
echo "$kuning / Thanks to : ALLAH SWT                          /\n";
echo "$cyan ###################################################\n";
...
for($i = 1; $i < $max+1; $i++) {
	...
	echo $i.". [200OK] SUKSES MENGIRIM ~ [".$class->jalankan()."]\n";
}
